...
function ssm_get_settings() {
	...
	if ( null === $defaults ) {
		$defaults = array(
			...
			'twilio_max_concurrency'      => 10,
			'teams_max_concurrency'       => 10,
			...
			'smtp2go_rate_limit_per_second' => 10,
			'smtp2go_max_concurrency'     => 10,
			'smtp2go_timeout'             => 15,
			'smtp2go_fallback_to_wp_mail' => true,
			'smtp_enabled'                => false,
			'smtp_host'                   => '',
			'smtp_port'                   => 587,
			'smtp_encryption'             => 'tls',
